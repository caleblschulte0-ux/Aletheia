...
Generated 2026-08-25T16:11:39Z from fleet registry rev 3 via LocalSource.

## ⚪ `Aletheia` — hub (active)

The fleet's single pane of truth: registry, pulse collector, interface, ChatGPT suggestion inbox.

Last commit `11c753f21cce` at 2026-08-25T15:57:19+00:00: Refoundation: master playbook adopted — contracts, capability registry, task engine, intercom

Watched workflows:
- `pulse.yml`: unavailable offline
- `ci.yml`: unavailable offline
...
- `exchange_phase_a.yml`: unavailable offline
- `exchange_phase_b.yml`: unavailable offline
- `story_forge.yml`: unavailable offline
- `third.yml`: unavailable offline
- `explainer.yml`: unavailable offline
- `retro.yml`: unavailable offline
- `doctor.yml`: unavailable offline
...
- `sell-brain.yml`: unavailable offline
- `trader.yml`: unavailable offline
- `watchdog.yml`: unavailable offline

## 💤 `Money_Machine` — unbuilt (stub)

Empty stub — nothing but a README. No behaviour to observe yet.

Last commit `53c6507f6afe` at 2026-08-05T14:11:54-05:00: Initial commit

## 💤 `etsy_maker` — unbuilt (stub)

Empty stub — nothing but a README. No behaviour to observe yet.

Last commit `1ecd2656a55d` at 2026-05-30T12:59:18-05:00: Initial commit

## 💤 `fosstester` — unbuilt (stub)

Empty stub — nothing but a README. No behaviour to observe yet.

Last commit `41ea84afb060` at 2026-06-03T10:08:19-05:00: Initial commit
