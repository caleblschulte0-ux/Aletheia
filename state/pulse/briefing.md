...
Generated 2026-09-11T21:01:17Z from fleet registry rev 5 via GitHubSource.
...
Watched workflows:
- `pulse.yml`: in_progress at 2026-09-11T21:01:13Z
- `ci.yml`: success at 2026-09-11T19:39:04Z
...
Last commit `a44c383fde44` at 2026-09-11T19:44:51Z: exchange: phase A bundle for 20260911 [skip ci]
...
- `exchange_phase_a.yml`: success at 2026-09-11T19:44:55Z
...
- `watchdog.yml`: success at 2026-09-11T19:21:50Z
...
Watched workflows:
- `barkly-ci.yml`: failure at 2026-09-11T19:59:46Z
...
- **Barkly** (`Money_Machine` @ `claude/barkley-mvp-mobile-qbegtj`, low risk): 0/8 steps; last human or builder commit 2026-09-11T19:44:46Z; next step 1 (thea): Get Barkly CI green on the project branch: its 'Production dependency audit' step fails on every push
...
- **Open Range demo films** (`Money_Machine` @ `claude/open-range-promo-video-4n7k7o`, low risk): 0/4 steps; last human or builder commit 2026-09-11T19:38:44Z; next step 1 (thea): Write a one-page status of the five-film slate in handoff/STATUS.md: which films are delivered, where each master and contact sheet lives, and what is still open
