...
- **Holdco platform** — 0/5 steps · last moved 40 days ago · Thea next: Bring the platform up to date and confirm pnpm test, typecheck and build still pass (last verified 2026-08-06) · yours next: Pick the one offer to test first and write it as one sentence in docs/NEXT_OFFER.md on the holdco branch (or tell any Claude session to) · 1 open builder pull request
- **Open Range demo films** — 0/4 steps · last moved 1 day ago · Thea next: Write a one-page status of the five-film slate in handoff/STATUS.md: which films are delivered, where each master and contact sheet lives, and what is still open
...
- trending posted 324 · explainer posted 248 · third posted 510 · curiosity posted 1
- last commit `15fa69d9ff22`: doctor: evidence pack + backlog 2026-09-15 [skip ci]
...
---
pulse `2026-09-15T11:50:57Z` · registry rev 5 · composed by `aletheia.brief`
