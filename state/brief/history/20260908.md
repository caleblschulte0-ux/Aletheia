# ☀️ Fleet brief — 2026-09-08

**2 fault(s) need eyes:** `Shorts-pipeline`, `schwab-trader`

## Aletheia — OPERATIONAL
- last commit `60408a220fe6`: pulse: 2026-09-08T04:45Z

## Shorts-pipeline — FAULT
- trending posted 316 · explainer posted 235 · third posted 446 · curiosity posted 1
- last commit `8d5930fedd4b`: doctor: evidence pack + backlog 2026-09-08 [skip ci]

## schwab-trader — FAULT
- last commit `3aa51318e74d`: sell-brain: update exit decisions [skip ci]
...
- `21:34` [alert] repo:shorts_pipeline: health green -> red
- `21:34` [alert] repo:schwab_trader: health green -> red
- `21:34` [alert] sentinel: alert issue opened — Shorts-pipeline, schwab-trader

---
pulse `2026-09-08T11:25:53Z` · registry rev 4 · composed by `aletheia.brief`
