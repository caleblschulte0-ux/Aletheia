...
def registry() -> dict[str, Provider]:
    ...
    from aletheia import mission_browser, mission_conversations, mission_jobs, mission_programs, mission_sessions, mission_work
    ...
    providers = (mission_jobs.PROVIDER, mission_browser.PROVIDER, mission_sessions.PROVIDER,
                 mission_work.PROVIDER, mission_programs.PROVIDER, mission_conversations.PROVIDER)
