(() => {
  ...
  async function api(path, options={}) {
    // Reads are open on loopback; WRITES need the local session secret the
    // Core injects into the served .html (core.py _serve_file). Without
    // this the panels fill in and every button 401s.
